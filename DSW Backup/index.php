            ...
            <header class="bg-dark py-5">
                <div class="container px-5">
                    <div class="row gx-5 align-items-center justify-content-center">
                        ...
                        <div class="col-xl-5 col-xxl-6 d-none d-xl-block text-center"><img class="img-fluid rounded-3 my-5" src="img/105.jpg" alt="..." /></div>
                    </div>
                </div>
            </header>
            <!-- Features section-->
                    ...
                    <div class="row gx-5 justify-content-center">
                        <div class="col-lg-10 col-xl-7">
                            <div class="text-center">
                                <div class="fs-4 mb-4 fst-italic">"We are here to listen to you needs and deliver exellence by any means.

Our main service is a one-stop shop which does everything to assist with funeral adminsitration and life insurance.Our agents are ready to assist you every step of the way"</div>
                                <div class="d-flex align-items-center justify-content-center">
                                    <img class="rounded-circle me-3" src="https://dummyimage.com/40x40/ced4da/6c757d" alt="..." />
                                    <div class="fw-bold">
                                        Thuso Mokoena
                                        <span class="fw-bold text-primary mx-1">/</span>
                                        CEO, Bophelo Solutions
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="container px-5 my-5">
                    <div class="row gx-5 justify-content-center">
                        <div class="col-lg-8 col-xl-6">
                            <div class="text-center">
                                <h2 class="fw-bolder">From our Social Media</h2>
                                <p class="lead fw-normal text-muted mb-5">"A brand is no longer what we tell the consumer it is — it is what consumers tell each other it is" - Scott Cook, founder, Intuit</p>
                            </div>
                        </div>
                    </div>
                    <div class="row gx-5">
                        <div class="col-lg-4 mb-5">
                            <div class="card h-100 shadow border-0">
                                <img class="card-img-top" src="img/fb.jpg" alt="..." />
                                <div class="card-body p-4">
                                    <div class="badge bg-primary bg-gradient rounded-pill mb-2">Facebook</div>
                                    <a class="text-decoration-none link-dark stretched-link" href="https://www.facebook.com/Bophelo-Solutions-103776375239828/"><h5 class="card-title mb-3">Don’t say anything online that you wouldn’t want plastered on a billboard with your face on it.</h5></a>
                                    <p class="card-text mb-0">Erin Bury</p>
                                </div>
                        ...
                        <div class="col-lg-4 mb-5">
                            <div class="card h-100 shadow border-0">
                                <img class="card-img-top" src="img/fb.jpg" alt="..." />
                                <div class="card-body p-4">
                                    <div class="badge bg-primary bg-gradient rounded-pill mb-2">Twiiter</div>
                                    <a class="text-decoration-none link-dark stretched-link" href="https://twitter.com/bophelosolution?s=21"><h5 class="card-title mb-3">Social media allows big companies to act small again</h5></a>
                                    <p class="card-text mb-0">-Jay Baer</p>
                                </div>
                                <div class="card-footer p-4 pt-0 bg-transparent border-top-0">
                                    <div class="d-flex align-items-end justify-content-between">
                                        <div class="d-flex align-items-center">
                        ...
                        <div class="col-lg-4 mb-5">
                            <div class="card h-100 shadow border-0">
                                ...
                                <div class="card-body p-4">
                                    ...
                                    <a class="text-decoration-none link-dark stretched-link" href="https://instagram.com/bophelosolutions?utm_medium=copy_link"><h5 class="card-title mb-3">Content marketing is a commitment, not a campaign.</h5></a>
                                    <p class="card-text mb-0">Jon Buscall</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
<script>
  ...
  var firebaseConfig = {
    apiKey: "AIzaSyANaL1vs6ww04sAvPmQAUHgsdvuST3pyGo",
    authDomain: "bophelo-solutions.firebaseapp.com",
    projectId: "bophelo-solutions",
    storageBucket: "bophelo-solutions.appspot.com",
    messagingSenderId: "688999582000",
    appId: "1:688999582000:web:fe5a94bac69d8b55aa60f5",
    measurementId: "G-7GE6HXWLWR"
  };
  // Initialize Firebase
